...
/**
 * Activity for displaying job offers in the Economics category.
 */
public class EconomicsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Firebase Database reference for Economics category
        DB = FirebaseDatabase.getInstance().getReference();
        DatabaseReference economicsRef = DB.child("OFFERS/Economics");

        // Set up ValueEventListener to fetch and display job offers
        economicsRef.addValueEventListener(
                        ...
                        APPLY.setOnClickListener(
                            new View.OnClickListener() {
                                ...
                                public void onClick(View view) {
                                    ...
                                    Intent intent = new Intent(EconomicsActivity.this, JobDetailsActivity.class);
        ...
        addApp.setOnClickListener(view -> startActivity(new Intent(EconomicsActivity.this, AddApplicationActivity.class)));
        backBtn.setOnClickListener(view -> finish());
        homeBtn.setOnClickListener(view -> startActivity(new Intent(EconomicsActivity.this, CategoriesActivity.class)));
    }
}
