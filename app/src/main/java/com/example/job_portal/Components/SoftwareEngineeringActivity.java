...
/**
 * Activity for displaying software engineering job offers.
 */
public class SoftwareEngineeringActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Reference to the "Software Engineering" node in the database
        DatabaseReference softwareRef = DB.child("OFFERS/Software Engineering");

        // Event listener to retrieve and display software engineering job offers
        softwareRef.addValueEventListener(new ValueEventListener() {
            @Override
                ...
                for (DataSnapshot ds : snapshot.getChildren()) {
                    ...
                    APPLY.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            Intent intent = new Intent(SoftwareEngineeringActivity.this, JobDetailsActivity.class);
        ...
        addApp.setOnClickListener(view -> {
            startActivity(new Intent(SoftwareEngineeringActivity.this, AddApplicationActivity.class));
        });
        ...
        homeBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(SoftwareEngineeringActivity.this, CategoriesActivity.class));
            }
        });
    }
}
